<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/DoctorMaster.Master" AutoEventWireup="true" CodeBehind="ViewPatientMedicalRecords.aspx.cs" Inherits="DBProject.Doctor.ViewPatientMedicalRecords" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>病人基本病歷資料查詢</title>   
...
<asp:Content ID="Content2" ContentPlaceHolderID="Cp1" runat="server" >
        ...
        <asp:Label ID="Msg" runat="server" Font-Bold="True"></asp:Label>
            ...
            runat="server" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="2px" CellPadding="8" Caption="病人清單" CaptionAlign="Top" HorizontalAlign="Center" Width="380px"  GridLines="Horizontal" CellSpacing="3" AutoGenerateSelectButton="True">
