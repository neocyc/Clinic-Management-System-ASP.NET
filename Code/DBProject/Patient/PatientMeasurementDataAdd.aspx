                                ...
                                <table class="table table-bordered">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><asp:TextBox ID="systolicbloodpressureT" runat="server" type="text" class="form-username form-control" placeholder="請填寫血壓(收縮壓)" ></asp:TextBox> / <asp:TextBox ID="diastolicbloodpressureT" runat="server" type="text" class="form-username form-control" placeholder="請填寫血壓(舒張壓)" ></asp:TextBox></td>
                        ...
                        <!-- sign up form start honay laga hai :)-->                         
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="systolicbloodpressureF" runat="server" type="text" class="form-username form-control" placeholder="請填寫血壓(收縮壓)"></asp:TextBox>
                                /      
                                <asp:TextBox ID="diastolicbloodpressureF" runat="server" type="text" class="form-username form-control" placeholder="請填寫血壓(舒張壓)"></asp:TextBox>
                            </div> 
